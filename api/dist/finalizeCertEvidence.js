...
exports.finalizeCertEvidence = finalizeCertEvidence;
const functions_1 = require("@azure/functions");
const cosmos_1 = require("./utils/cosmos");
const auth_1 = require("./utils/auth");
const http_1 = require("./utils/http");
function finalizeCertEvidence(request, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { certId, evidenceId, sha256, size, contentType, setCurrent } = body || {};
            if (!certId || !evidenceId || !sha256 || !size)
                return http_1.ERR.VALIDATION('Missing required fields', { required: ['certId', 'evidenceId', 'sha256', 'size'] });
            ...
            return (0, http_1.ok)({ evidence, cert });
        }
        catch (error) {
...
functions_1.app.http('finalizeCertEvidence', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: finalizeCertEvidence,
});
//# sourceMappingURL=finalizeCertEvidence.js.map