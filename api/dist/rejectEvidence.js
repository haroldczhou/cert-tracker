...
exports.rejectEvidence = rejectEvidence;
const functions_1 = require("@azure/functions");
const cosmos_1 = require("./utils/cosmos");
const auth_1 = require("./utils/auth");
const http_1 = require("./utils/http");
const audit_1 = require("./utils/audit");
function rejectEvidence(request, context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { certId, evidenceId, reason } = body || {};
            ...
            evidence.rejectedAt = new Date().toISOString();
            evidence.rejectionReason = reason !== null && reason !== void 0 ? reason : null;
            evidence.updatedAt = new Date().toISOString();
            yield cosmos_1.entities.items.upsert(evidence);
            yield (0, audit_1.auditLog)(districtId, userId !== null && userId !== void 0 ? userId : null, 'reject_evidence', 'cert', cert.id, { evidenceId, reason: reason !== null && reason !== void 0 ? reason : null });
...
functions_1.app.http('rejectEvidence', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: rejectEvidence,
});
//# sourceMappingURL=rejectEvidence.js.map